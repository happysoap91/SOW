...
\begin{itemize}
    ...
    Nucleation event is the creation of void in the material. As stress is applied uni-axially, bonds break and form among atoms. Correspondingly, some atoms have growing void among themselves and others are squished into more dense regions as the fracture nucleates alongside the void occurrence. 
    \begin{figure}
    \centering
    \noindent
    \includegraphics[width=8cm, height=6cm]{picture/volcolor.PNG}
    \caption{Red atoms have vol greater than 42}
    \label{crack_Fig}
\end{figure}
